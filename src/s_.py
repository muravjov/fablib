...
def parse_date(utc_ts_str):
    import iso8601
    # :TRICKY: чтобы можно было сравнивать, необходимы
    # наличие/отстутствие tz у обоих
    ts = iso8601.parse_date(utc_ts_str, None)
    # :TRICKY: в новой версии форсят UTC-зону
    if ts.tzinfo:
